...
if (!isset($_SESSION['email'])) {
    die('<div class="min-h-screen flex items-center justify-center bg-gray-100"><p class="text-red-600 font-semibold">Você precisa estar logado para acessar o quiz.</p></div>');
}
...
if (isset($_SESSION['ultimo_quiz_data']) && $_SESSION['ultimo_quiz_data'] == $hoje) {
    die('<div class="min-h-screen flex items-center justify-center bg-gray-100 text-center p-4">
        ...
        <p class="text-gray-800 font-semibold">Você já jogou o quiz diário hoje.</p>
...
<body class="bg-gray-100 min-h-screen flex flex-col items-center py-10">
  <div class="w-full max-w-3xl bg-white shadow rounded p-6">
    ...
    <form method="POST" action="SR_diario.php" class="space-y-6">
