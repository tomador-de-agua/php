...
<body id="page-module-template">
  ...
  <main style="padding:80px 20px; min-height:100vh;">
    ...
    <br>
    <div class="lado">
        <input type="radio" name="teste1" id="teste1"> 12 <br>
        <input type="radio" name="teste1" id="teste1"> Não vejo nada
    </div>
    <br>
    <img src="../img/teste2.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste2" id="teste2"> 8
    <input type="radio" name="teste2" id="teste2"> 3
    <input type="radio" name="teste2" id="teste2"> Não vejo nada
    <br>
    <img src="../img/teste3.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste3" id="teste3"> 29
    <input type="radio" name="teste3" id="teste3"> 70   
    <input type="radio" name="teste3" id="teste3"> Não vejo nada
    <br>
    <img src="../img/teste4.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste4" id="teste4"> 5
    <input type="radio" name="teste4" id="teste4"> 2
    <input type="radio" name="teste4" id="teste4"> Não vejo nada
    <br>
    <img src="../img/teste5.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste5" id="teste5"> 3
    <input type="radio" name="teste5" id="teste5"> 5
    <input type="radio" name="teste5" id="teste5"> Não vejo nada
    <br>
    <img src="../img/teste6.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste6" id="teste6"> 15  
    <input type="radio" name="teste6" id="teste6"> 17
    <input type="radio" name="teste6" id="teste6"> Não vejo nada
    <br>
    <img src="../img/teste7.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste7" id="teste7"> 74 
    <input type="radio" name="teste7" id="teste7"> 21
    <input type="radio" name="teste7" id="teste7"> Não vejo nada
    <br>
    <img src="../img/teste8.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste8" id="teste8"> 6
    <input type="radio" name="teste8" id="teste8"> Não vejo nada
    <br>
    <img src="../img/teste9.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste9" id="teste9"> 45
    <input type="radio" name="teste9" id="teste9"> Não vejo nada
    <br>
    <img src="../img/teste10.jpg" height="300px" alt="">
    <br>
    <input type="radio" name="teste10" id="teste10"> 5
    <input type="radio" name="teste10" id="teste10"> Não vejo nada
    <br>
